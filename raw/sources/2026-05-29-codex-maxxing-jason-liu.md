...
canonical_url: https://jxnl.github.io/blog/writing/2026/05/10/codex-maxxing/
ingested: 2026-05-29
ingested_by: agent-alpha
source_type: article
category: [agent-engineering, codex]
credibility_tier: unknown
credibility_note: "Practitioner blog by Jason Liu; primary for his workflow, secondary for OpenAI product behavior unless corroborated by linked official docs."
evidence_grade: unknown
context: "Historical Tolaria backfill from session /home/admin/.hermes/profiles/agent-alpha/sessions/session_20260518_035944_467089.json message_index 8. User requested normal Alpha ingestion path and useful Beta cards only."
immutable_raw: true
---
...
- Original URL: https://jxnl.github.io/blog/writing/2026/05/10/codex-maxxing
- Canonical URL: https://jxnl.github.io/blog/writing/2026/05/10/codex-maxxing/
- Fetched URL: https://jxnl.github.io/blog/writing/2026/05/10/codex-maxxing/
- Content type: text/html; charset=utf-8
- Raw markdown URL: https://github.com/jxnl/blog/raw/main/docs/writing/posts/codex-maxxing.md
- Raw markdown fetched URL: https://raw.githubusercontent.com/jxnl/blog/main/docs/writing/posts/codex-maxxing.md
- Raw markdown content type: text/plain; charset=utf-8
- Source category from backfill: agent-engineering, codex
- Credibility tier from backfill: unknown
- Evidence grade from backfill: unknown

## Embedded links extracted

- [https://github.com/jxnl/blog/edit/main/docs/writing/posts/codex-maxxing.md](https://github.com/jxnl/blog/edit/main/docs/writing/posts/codex-maxxing.md)
- [https://github.com/jxnl/blog/raw/main/docs/writing/posts/codex-maxxing.md](https://github.com/jxnl/blog/raw/main/docs/writing/posts/codex-maxxing.md)
...
- [OpenAI describes it as a way to work with Codex from anywhere](https://openai.com/index/work-with-codex-from-anywhere/)
- [Rich](https://github.com/Textualize/rich)
- [Slidev](https://sli.dev/guide/)
- [Thariq has a very good post](https://x.com/trq212/status/2052809885763747935)

## Embedded links inspected summary

- OpenAI Agents SDK announcement — official page partially blocked in this environment; indexed/mirrored evidence points to sandbox execution and model-native harness concepts relevant to safe long-running file/tool agents.
- OpenAI “Work with Codex from anywhere” — official article supports remote/mobile steering, live state, approvals, diffs/test/screenshots/terminal output, secure relay, SSH, enterprise hooks/tokens.
- openai/openai-cli — official Go CLI for OpenAI REST API; relevant to API/file/vector-store automation, not direct evidence for Codex durable loops.
- Codex Chronicle docs — opt-in macOS Pro preview for screen-derived local Markdown memories; relevant as ambient-memory design pattern with privacy/prompt-injection cautions.
- Codex app settings/pets — lightweight ambient status UI for running/waiting/review states; UX inspiration only.
- Slidev and Slidev AI tools — Markdown/web slide artifact system with official AI skill and VS Code LM tools; relevant to agent-produced artifacts and structured project introspection.
- Textualize Rich — terminal rendering library; presentation/diagnostic UX inspiration.
- Thariq X post on HTML artifacts — argues HTML can be denser/more interactive than Markdown for plans/specs/reviews/reports; useful as output-artifact hypothesis, but canonical Tolaria sources should stay Markdown unless explicitly promoted.
...
Codex also has first-party memory features in Settings > Personalization > Memories. I think of those as a local recall layer: useful for stable preferences, recurring workflows, project conventions, and known pitfalls, but not a replacement for checked-in instructions or an explicit vault. Chronicle is especially interesting here because it can use recent screen context to help build memories. I have not used it seriously yet, and the docs are clear that it is an opt-in research preview with real tradeoffs around permissions, rate limits, prompt injection, and unencrypted local memory files. But directionally it points at the same thing I care about: work should leave behind structured memory, not just a longer chat transcript.
...
Skills make repeated workflows reusable. Skill Creator and Skill Installer are a good place to start. Skill Installer lets you add OpenAI-recommended skills directly from the composer. After Codex pets launched, I used it to install the Hatch Pet skill, but the useful pattern is general: once you do something useful once, you can often package it so Codex can do it again without reteaching the workflow.
 
Remote control¶
 
Remote control makes these longer loops feel portable.
 
Codex can keep working from the machine where your files, permissions, and local setup already live, while you check in from mobile, review what it found, answer a question, approve the next step, or change direction without being back at your desk. OpenAI describes it as a way to work with Codex from anywhere.
...
Thariq has a very good post about preferring HTML over Markdown as an output format. I think that instinct is right. Once the output is a small application instead of just a document, the relationship changes.
